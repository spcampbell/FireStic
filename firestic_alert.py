...
def buildTextMessage(emailData):
	...
	textEmail = textEmail + u'Type: ' + emailData['alertname'] + u'\nAction: ' + emailData['action'] + u'\n'
	textEmail = textEmail + u'Severity: ' + emailData['severity'] +  u'\nThreat: ' +  emailData['threatname'] + u'\n'
	textEmail = textEmail + u'Source: ' + emailData['sourceip'] + u'\n' + emailData['sourcecity'] + u',' + emailData['sourceregion'] + u'\n'
	textEmail = textEmail + emailData['sourcecountry'] + u'\n' + emailData['sourceasn'] + u'\n'
	textEmail = textEmail + u'Destination: ' + emailData['destinationip'] + u'\n' + emailData['destinationcity'] + u',' + emailData['destinationregion'] + u'\n'
	textEmail = textEmail + emailData['destinationcountry'] + u'\n' + emailData['destinationasn']
...
def gatherEmailData(alertData,myTimezone):
	...
	if emailData['severity'] in severityLevels: emailData['severity'] = severityLevels[emailData['severity']]
	...
	# source detail
	if alertData['src'].setdefault('geoip',{}) is None: alertData['src']['geoip'] = {}
	if alertData['src']['geoip'].setdefault('city',emptyValue) is None: alertData['src']['geoip']['city'] = emptyValue
	emailData['sourcecity'] = alertData['src']['geoip']['city']
	if alertData['src']['geoip'].setdefault('region_code',emptyValue) is None: alertData['src']['geoip']['region_code'] = emptyValue
	emailData['sourceregion'] = alertData['src']['geoip']['region_code']	
	if alertData['src']['geoip'].setdefault('country_name',emptyValue) is None: alertData['src']['geoip']['country_name'] = emptyValue
	emailData['sourcecountry'] = alertData['src']['geoip']['country_name']	
	if alertData['src']['geoip'].setdefault('asn',emptyValue) is None: alertData['src']['geoip']['asn'] = emptyValue
	emailData['sourceasn'] = alertData['src']['geoip']['asn']	
	if alertData['src']['geoip'].setdefault('hostname',emptyValue) is None: alertData['src']['geoip']['hostname'] = emptyValue
	emailData['sourcehostname'] = alertData['src']['geoip']['hostname']	
	
	#destination detail
	if alertData['dst'].setdefault('geoip',{}) is None: alertData['dst']['geoip'] = {}
	if alertData['dst']['geoip'].setdefault('city',emptyValue) is None: alertData['dst']['geoip']['city'] = emptyValue
	emailData['destinationcity'] = alertData['dst']['geoip']['city']
	if alertData['dst']['geoip'].setdefault('region_code',emptyValue) is None: alertData['dst']['geoip']['region_code'] = emptyValue
	emailData['destinationregion'] = alertData['dst']['geoip']['region_code']	
	if alertData['dst']['geoip'].setdefault('country_name',emptyValue) is None: alertData['dst']['geoip']['country_name'] = emptyValue
	emailData['destinationcountry'] = alertData['dst']['geoip']['country_name']	
	if alertData['dst']['geoip'].setdefault('asn',emptyValue) is None: alertData['dst']['geoip']['asn'] = emptyValue
	emailData['destinationasn'] = alertData['dst']['geoip']['asn']	
	if alertData['dst']['geoip'].setdefault('hostname',emptyValue) is None: alertData['dst']['geoip']['hostname'] = emptyValue
